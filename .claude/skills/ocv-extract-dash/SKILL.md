...
| **Path** | Diagnosed routing path slug from `scripts/agent_models_reference.json` (e.g. `Sydney-Tools+WorkBerry`, `CodeGen-Claude`, `CodeGen-GHCP`, `CodeGen-GHCP-mini`, `Sydney-Tools`, `Unknown`). |
